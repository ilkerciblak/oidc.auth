...
type appConfig struct {
	...
	FACEBOOK_CLIENT_SECRET string `json:"facebook_client_secret"`
	FACEBOOK_CLIENT_ID     string `json:"facebook_client_id"`
	FACEBOOK_REDIRECT_URI  string `json:"facebook_redirect_uri"`
	FACEBOOK_DISCOVER_URI  string `json:"facebook_discover_uri"`
}
...
func LoadConfig() *appConfig {
	return &appConfig{
		...
		FACEBOOK_CLIENT_SECRET: getEnvString("FACEBOOK_CLIENT_SECRET ", ""),
		FACEBOOK_CLIENT_ID:     getEnvString("FACEBOOK_CLIENT_ID", ""),
		FACEBOOK_REDIRECT_URI:  getEnvString("FACEBOOK_REDIRECT_URI", ""),
		FACEBOOK_DISCOVER_URI:  getEnvString("FACEBOOK_DISCOVER_URI", ""),
	}
}
